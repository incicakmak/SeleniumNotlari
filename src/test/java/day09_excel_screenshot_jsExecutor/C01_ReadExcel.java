...
public class C01_ReadExcel {
    ...
    public  void test01() throws IOException {
        ...
        /*
        Biz kodlarimizla bilgisayardaki bir dosyaya erisim saglayip
        anlik o dosyadan bilgi almayiz

        bunun yerine class'ın basinda,  kod ortamimizda bilgisayarimizdaki excel dosyasinin
       ...
       // 1- bilgisayardaki excel'e ulasabilmek icin dosyaYolu gerekir.
        ...
        // Bilgisayarimizdaki excel'in icindeki tum bilgiler
        // artik bu workbook'un objesinin icinde kayitli
        // excel'in yapisi geregi, sirayla
        // - istenen sayfa
        // - istenen satir
        // - istenen hucre
        // olusturlmalidir / okumalidir.


        //12. satirin  3. hucresinin "Azerbaycan" oldugunu test edin.
        Sheet sayfa1= workbook.getSheet("Sayfa1");
        //excel'de index kullanilir yani 0'dan baslar.
